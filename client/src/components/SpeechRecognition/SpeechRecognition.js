...
let randomWordArr = ["Incredible","Love","Night","Sweet","Dream","Work","Phone","One","Beauty","Late","Good","Forever","Rainbow","Dance","Dangerous","Baby","Queen","Hair","Light","Heart","Honey","Broke","Name","Crazy","Woman","Deep","Again","World","Girl","Fire","Lady","Best","Lost","Trouble","Burn","Somebody","Sorry","Pretty","War","Stay","Slow","Song","Ring","Cream","Care","Have","Need","Hold","God","Deep","Together","Ain't","Imagine","Freedom","Fall","Think","Broken","Side","Mine","Boy","Never","Kiss","Wine","Girl","Bad","Hurt","Remember","Only","Perfect","Want","Time","Control","Blank","Liar","Breathe","Cry","Ready","Inside-Out","Eyes","Sexy","Dead","Blame","Blood","Make-Up","Proud","Mad","Close","Last","Man","Young","Style","Alone","Life","Rain","Forget","Quit","Friend","Space","Light","Song","Listen","Feel","Happy","Never","Home","Jump","Wild","Angel","Touch","Head"];
